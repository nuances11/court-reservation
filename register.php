...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content">
			...
			<img src="<?php echo BASE_URL ?>assets/images/logo3.png" width="120" alt="" />
			</a>
					...
					<div class="step current" id="step-1">
						...
						<div class="form-group">
							<div class="input-group">
								...
								<input type="text" class="form-control" name="name" id="name" placeholder="First Name" autocomplete="off" />
							</div>
						</div>	
						<div class="form-group">
							<div class="input-group">
								...
								<input type="number" class="form-control" name="contact" id="contact" placeholder="Phone Number" data-mask="phone" autocomplete="off" />
							</div>
						</div>
